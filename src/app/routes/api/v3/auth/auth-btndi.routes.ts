...
import * as AuthBtNdiController from '../../../../modules/auth/btndi/auth-btndi.controller'

export const AuthBTNDIRouter = Router()

AuthBTNDIRouter.get('/authurl', AuthBtNdiController.generateAuthUrl)
 ...
 */
// AuthBTNDIRouter.get('/login/callback', AuthBtNdiController.handleLoginCallback)
 ...
 */
// AuthBTNDIRouter.get('/profiles', AuthBtNdiController.getProfiles)
 ...
 */
// AuthBTNDIRouter.post('/profiles', AuthBtNdiController.setProfile)
